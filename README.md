...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 436,154 | 🐛 68 | 📅 2026-01-28 [![Link Verification](https://github.com/janikvonrotz/awesome-powershell/actions/workflows/markdownLinkDaily.yml/badge.svg)](https://github.com/janikvonrotz/awesome-powershell/actions/workflows/markdownLinkDaily.yml) ⚠️ Archived
...
* [psake](https://github.com/psake/psake) ⭐ 1,604 | 🐛 26 | 🌐 PowerShell | 📅 2025-09-04 - Build automation tool inspired by rake (aka make in Ruby) and bake (aka make in Boo).
...
* [thefuck](https://github.com/nvbn/thefuck) ⭐ 95,428 | 🐛 405 | 🌐 Python | 📅 2024-07-19 - Magnificent app which corrects your previous console command (by typing `fuck`).
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 33,256 | 🐛 151 | 🌐 Rust | 📅 2026-02-07 - A better way to navigate your filesystem. Written in Rust, cross-shell, and much faster than other autojumpers.
* [posh-git](https://github.com/dahlbyk/posh-git) ⭐ 8,144 | 🐛 113 | 🌐 PowerShell | 📅 2024-09-02 - Set of PowerShell scripts which provide Git/PowerShell integration.
* [poco](https://gist.github.com/yumura/8df37c22ae1b7942dec7)\* [peco](https://github.com/peco/peco) ⭐ 7,858 | 🐛 52 | 🌐 Go | 📅 2025-11-09 implementation. Interactive filtering tool.
...
* [PSFzf](https://github.com/kelleyma49/PSFzf) ⭐ 1,074 | 🐛 50 | 🌐 PowerShell | 📅 2026-01-24 - a PowerShell module that wraps [fzf](https://github.com/junegunn/fzf) ⭐ 77,641 | 🐛 323 | 🌐 Go | 📅 2026-02-09, a fuzzy file finder for the command line.
...
* [Zlocation](https://github.com/vors/ZLocation) ⭐ 612 | 🐛 31 | 🌐 PowerShell | 📅 2024-05-22 \* [z.sh](https://github.com/rupa/z) ⭐ 16,915 | 🐛 105 | 🌐 Shell | 📅 2024-06-19 implementation for PowerShell. Similar to Jump-Location.
* [Jump-Location](https://github.com/tkellogg/Jump-Location) ⭐ 471 | 🐛 17 | 🌐 C# | 📅 2019-09-26 - PowerShell `cd` that reads your mind. [Autojump](https://github.com/wting/autojump) ⭐ 16,825 | 🐛 225 | 🌐 Python | 📅 2025-02-27 implementation for PowerShell. **`UNMAINTAINED`**
...
* [ImportExcel](https://github.com/dfinke/ImportExcel) ⭐ 2,688 | 🐛 11 | 🌐 PowerShell | 📅 2025-12-26 - Module to import/export Excel spreadsheets, without Excel.
...
* [BloodHound](https://github.com/BloodHoundAD/BloodHound) ⭐ 10,537 | 🐛 94 | 🌐 PowerShell | 📅 2025-08-01 - Easily identify highly complex attack paths that would otherwise be impossible to quickly identify.
* [Nishang](https://github.com/samratashok/nishang) ⭐ 9,736 | 🐛 21 | 🌐 PowerShell | 📅 2024-04-25 - Enables scripting for red team, penetration testing, and offensive security.
* [PowerShellEmpire](https://github.com/PowerShellEmpire/Empire) ⚠️ Archived - Post-exploitation agent.
* [Invoke-Obfuscation](https://github.com/danielbohannon/Invoke-Obfuscation) ⭐ 4,191 | 🐛 13 | 🌐 PowerShell | 📅 2023-08-10 - PowerShell Obfuscator.
...
* [Starship](https://github.com/starship/starship) ⭐ 53,994 | 🐛 973 | 🌐 Rust | 📅 2026-02-09 - The minimal, blazing fast, and extremely customizable prompt for any shell.
* [Oh-My-Posh](https://github.com/jandedobbeleer/oh-my-posh) ⭐ 21,464 | 🐛 31 | 🌐 Go | 📅 2026-02-09 - Tons of beautiful theme that can be enabled by one single command (includes many awesome powerline theme).
...
* [BurntToast](https://github.com/Windos/BurntToast) ⭐ 1,631 | 🐛 3 | 🌐 PowerShell | 📅 2025-11-17 - Module for creating and displaying Toast Notifications on Microsoft Windows 10.
...
* [WSLab](https://github.com/microsoft/WSLab) ⭐ 1,281 | 🐛 21 | 🌐 PowerShell | 📅 2025-10-21 - Windows Server rapid lab deployment scripts.
